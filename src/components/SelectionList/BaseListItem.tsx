...
function BaseListItem<TItem extends ListItem>({
    ...
    shouldPreventBackgroundHighlight = false,
    ...
    return (
        ...
        >
            <PressableWithFeedback
                ...
                style={[
                    pressableStyle,
                    !shouldPreventBackgroundHighlight && isFocused && StyleUtils.getItemBackgroundColorStyle(!!item.isSelected, !!isFocused, !!item.isDisabled, theme.activeComponentBG, theme.hoverComponentBG),
                ]}
                onFocus={onFocus}
